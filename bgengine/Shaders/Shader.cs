...
namespace BGEngine.Shaders
{
    public class Shader : IDisposable
    {
        ...
        private bool Compile(string vertexSource, string fragmentSource)
        {
            ...
            if (vertexSource != "")
            {
                CompileVertexSource(vertexSource, ref status_code, ref info);
            }

            if (fragmentSource != "")
            {
                CompileFragmentSource(fragmentSource, ref status_code, ref info);
            }
        ...
        private void CompileFragmentSource(string fragmentSource, ref int status_code, ref string info)
        {
        ...
        private void CompileVertexSource(string vertexSource, ref int status_code, ref string info)
        {
        ...
        private int GetVariableLocation(string name)
        {
            ...
            if (location != -1)
                ...
                Console.WriteLine("[Shader] Variable {0} not found.", name);
        ...
        /// <summary>
        /// Change a float[] Variable of the Shader
        /// </summary>
        /// <param name="name">Variable Name</param>
        /// <param name="array">Array of floats</param>
        public void SetVariable(string name, float[] array)
        {
            if (Program > 0)
            {
                GL.UseProgram(Program);
